...
import com.ns.base.domain.OauthAccessToken;
import com.ns.base.domain.OauthRefreshToken;
import com.ns.base.dto.JWTCommon;
import com.ns.base.dto.UserCredentials;
import com.ns.base.repository.OauthAccessTokenRepository;
import com.ns.base.repository.OauthRefreshTokenRepository;
...
public class JWTDataTokenStore extends JwtTokenStore {
	...
	public OAuth2Authentication readAuthentication(OAuth2AccessToken paramOAuth2AccessToken) {
		...
		if (!token2.isClientOnly()) {
			...
			UserCredentials loggedUser = (UserCredentials) token2.getUserAuthentication().getPrincipal();
